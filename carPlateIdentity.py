...
def locate_carPlate(orig_img,pred_image):
    ...
    #print(cv2.findContours(pred_image, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', type=str, help='object image number')
    ...
    char_model_path = os.path.join(cur_dir,'./carIdentityData/model/char_recognize/model.ckpt-1000.meta')
    img = cv2.imread('./carIdentityData/images/'+args.o+'.jpg')
